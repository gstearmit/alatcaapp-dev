(function() {
	// autoresize
//	$(function() {
//	    $( ".ui-sortable" ).resizable({ handles: 'e' });
//	        $(".ui-sortable").bind("resize", function (event, ui) {
//	           $('.wigetdrapdrop').width(800 -(ui.size.width - 525));
//	           $('.wigetdrapdrop').css("right",ui.size.width - ui.originalSize.width);
//	        });
//	  });  
	
  //click error 404
//	$('.error404').live("click", function(e) {
//		$("body").addClass("error").addClass("contrast-background");
//		
//	});
	
	//add scroll role_user
//	$('.navigation ul:eq(1) li:eq(3) ').live("click", function(e) {
//		alert('add classvvvvvvvvvvvvvv');
//		//$("body").addClass("error").addClass("contrast-background");
//	   $('.navigation ul:eq(1)').addClass('navscroll2');
//		
//});
  ...
  $(document).ready(function() {
	  //remove anggular js scroll content
	 // $("#main-nav").removeClass("left_phucsidebar");
      //$("#content-resizer").css("visibility","hidden");
	 // $("#content-resizer").css("display","none");
      //
  	
      //	console.log($(".icon-caret-right"));
//      console.log($("#main-nav .navigation > .nav > li > a span").live("click", function(e) {
//    	  $("#main-nav").addClass("left_phucsidebar");
//          $("#content-resizer").css("display","block")
//        }));
//      return;
      
//      
//      $("#main-nav .navigation > .nav > li .nav.in").on("click", function(e) {
//    	  alert("toi duoc click");
//    	 
//         $("#content-resizer").css({"display":"block"});
//        // $("#main-nav").addClass("left_phucsidebar");
//         //$("#content-resizer").not(':visibility').remove();
//    	 
//        });
    ...
    nav_toggler.on(click_event, function() {
    	...
    	//alert("cai nay da duoc an");
    	//console.log($("#main-nav"));
    	//console.log($("#main-nav").removeClass("left_phucsidebar")); //return;
    	//console.log($("#content-resizer").css("display","none"));
    	 //remove anggular js scroll content
    	//$("#main-nav").removeClass("left_phucsidebar");
    	//$("#content-resizer").css("display","block")
    ...
    $(document).bind("nav-close", function(event, params) {
      ...
      //alert('add main-nav-closed');// return;
      $('.navigation ul').removeClass('navscroll2');
      $('#main-nav').removeClass('left_phucsidebar');
    ...
    return $(document).bind("nav-open", function(event, params) {
     ...
     // alert('add class main-nav-opened');// return;
      $('.navigation ul:first-child').addClass('navscroll2');
